...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $permissions = [
            ...
            ['name' => 'view voucher types', 'description' => 'Tipo', 'show' => true],
            ['name' => 'create voucher types', 'description' => 'Tipo', 'show' => true],
            ['name' => 'edit voucher types', 'description' => 'Tipo', 'show' => true],
            ...
            ['name' => 'create providers', 'description' => 'Proveedores', 'show' => true],
            ['name' => 'edit providers', 'description' => 'Proveedores', 'show' => true],
