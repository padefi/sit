...
class PermissionSeeder extends Seeder {
    ...
    public function run(): void {
        $permissions = [
            ...
            ['name' => 'view vouchers', 'description' => 'Comp. Proveedores', 'show' => true],
            ['name' => 'create vouchers', 'description' => 'Comp. Proveedores', 'show' => true],
            ['name' => 'edit vouchers', 'description' => 'Comp. Proveedores', 'show' => true],
