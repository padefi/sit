...
return new class extends Migration {
    ...
    public function up(): void {
        Schema::create('social_security_tax_withholdings', function (Blueprint $table) {
    ...
    public function down(): void {
        Schema::table('social_security_tax_withholdings', function (Blueprint $table) {
            $table->dropForeign(['idCat']);
            $table->dropForeign(['idUserCreated']);
            $table->dropForeign(['idUserUpdated']);
        });

        Schema::dropIfExists('social_security_tax_withholdings');
    }
};
