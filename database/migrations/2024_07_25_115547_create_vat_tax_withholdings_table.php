...
return new class extends Migration {
    ...
    public function up(): void {
        Schema::create('vat_tax_withholdings', function (Blueprint $table) {
    ...
    public function down(): void {
        Schema::table('vat_tax_withholdings', function (Blueprint $table) {
            $table->dropForeign(['idCat']);
            $table->dropForeign(['idUserCreated']);
            $table->dropForeign(['idUserUpdated']);
        });

        Schema::dropIfExists('vat_tax_withholdings');
    }
};
