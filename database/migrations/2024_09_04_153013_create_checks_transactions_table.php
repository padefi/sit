...
return new class extends Migration {
    ...
    public function up(): void {
        Schema::create('checks_transactions', function (Blueprint $table) {
            $table->id();
    ...
    public function down(): void {
        Schema::table('checks_transactions', function (Blueprint $table) {
        ...
        Schema::dropIfExists('checks_transactions');
    }
};
