...
class VoucherRequest extends FormRequest {
    ...
    public function rules(): array {
        return [
            ...
            'invoicePaymentDate' => ['required', 'date', 'after_or_equal:invoiceDate'],
    ...
    public function messages(): array {
        return [
            ...
            'invoicePaymentDate.after_or_equal' => 'La fecha de vencimiento no puede ser anterior a la fecha de emisión.',
